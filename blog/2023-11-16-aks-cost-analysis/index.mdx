...
We are pleased to announce that [OpenCost](https://opencost.io) is being integrated into Microsoft’s new [Azure Kubernetes Service (AKS) Cost Analysis tool](https://aka.ms/aks/cost-analysis) to enable usage metrics collection. Microsoft Azure customers can now experience native visibility of cost allocation based on Kubernetes-specific constructs.
