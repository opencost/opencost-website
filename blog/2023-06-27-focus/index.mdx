...
The work's just getting started, this is only the first [0.5 release of the specification](https://focus.finops.org/#specification), but we're excited to align the OpenCost project with FOCUS as it continues to evolve. If you're interested we encourage you to get involved with the OpenCost and FOCUS projects, and if you're at FinOps X stop by the Kubecost booth and ask more questions.
