...
To get started, simply deploy OpenCost and add any number of cloud accounts to see a unified view of all costs. You can view OpenCost documentation to learn about APIs usage and more.
