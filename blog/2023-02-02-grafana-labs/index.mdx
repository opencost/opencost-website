...
---
Reposted from the [Grafana Labs blog](https://grafana.com/blog/2023/02/02/how-grafana-labs-uses-and-contributes-to-opencost-the-open-source-project-for-real-time-cost-monitoring-in-kubernetes/): [How Grafana Labs uses and contributes to OpenCost](https://grafana.com/blog/)
