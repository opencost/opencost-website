...
OpenCost may be installed on-premises and provides default pricing that may be overridden.
...
*** There is currently no support for on-premises Cloud Costs pricing. ***
